    ...
    await transporter.sendMail({
      ...
      html: `
        ...
        <table border="1" cellpadding="6" cellspacing="0" style="border-collapse: collapse; font-family: Arial; font-size: 14px;">
          ...
          <tr>
            <td>PCMSO atualizado</td>
            <td>${checklist.pcmso ? "✅ Sim" : "❌ Não"}</td>
          </tr>
          <tr>
            <td>PPRA / PGR atualizado</td>
            <td>${checklist.ppra ? "✅ Sim" : "❌ Não"}</td>
          </tr>
          <tr>
            <td>Funcionários treinados em NR’s</td>
            <td>${checklist.treinamentos ? "✅ Sim" : "❌ Não"}</td>
          </tr>
        </table>
      `,
    });
